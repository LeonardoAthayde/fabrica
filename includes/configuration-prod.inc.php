<?php
	...
	switch (SERVER_INSTANCE) {
		...
		case 'prod':
			 ...
			 */
			define ('__DOCROOT__', '/home/cila/www/fabrica/www');
			
			//define ('__VIRTUAL_DIRECTORY__', 'http://192.168.1.101/fabrica/www');
			//define ('__VIRTUAL_DIRECTORY__', 'http://192.168.1.131/fabrica/www');
			define ('__VIRTUAL_DIRECTORY__', 'http://www.cila.com.br/fabrica/www');
