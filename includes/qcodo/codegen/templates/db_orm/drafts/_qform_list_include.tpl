...
?>
	...
	<p class="create">
		<a class="btn btn-default" href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__) ?>/<%= QConvertNotation::UnderscoreFromCamelCase($objTable->ClassName) %>_edit.php"><?php _t('Create a New'); ?> <?php _t('<%= $objTable->ClassName %>');?></a>
	</p>
