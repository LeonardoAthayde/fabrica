<?php
	 ...
	 * listing a collection of Costureira objects.  It includes
	 ...
	 * 
	 */
	class CostureiraDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Costureira datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Costureira object, or it can be any QQNode extending from QQN::Costureira().
		 * 
		 ...
		 * sorting using two fields from the Costureira object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Costureira
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Costureira::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Costureira, given the clauses above
			$this->DataSource = Costureira::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Costureira-based QQNode.
		 * It will also verify that it is a proper Costureira-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'costureira') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "costureira".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Costureira()->Id;
				case 'Nome': return QQN::Costureira()->Nome;
				case 'ImagemFla': return QQN::Costureira()->ImagemFla;
				default: throw new QCallerException('Simple Property not found in CostureiraDataGrid content: ' . $mixContent);
