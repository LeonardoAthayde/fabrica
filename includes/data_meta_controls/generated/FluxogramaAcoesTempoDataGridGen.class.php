<?php
	 ...
	 * listing a collection of FluxogramaAcoesTempo objects.  It includes
	 ...
	 * 
	 */
	class FluxogramaAcoesTempoDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this FluxogramaAcoesTempo datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the FluxogramaAcoesTempo object, or it can be any QQNode extending from QQN::FluxogramaAcoesTempo().
		 * 
		 ...
		 * sorting using two fields from the FluxogramaAcoesTempo object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from FluxogramaAcoesTempo
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = FluxogramaAcoesTempo::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from FluxogramaAcoesTempo, given the clauses above
			$this->DataSource = FluxogramaAcoesTempo::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a FluxogramaAcoesTempo-based QQNode.
		 * It will also verify that it is a proper FluxogramaAcoesTempo-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'fluxograma_acoes_tempo') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "fluxograma_acoes_tempo".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::FluxogramaAcoesTempo()->Id;
