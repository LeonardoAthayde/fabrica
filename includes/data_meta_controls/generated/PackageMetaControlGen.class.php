<?php
	 ...
	 * property QIntegerTextBox $NameControl
	...
	class PackageMetaControlGen extends QBaseClass {
		...
		/**
		 * Create and setup QIntegerTextBox txtName
		 * @param string $strControlId optional ControlId to use
		 * @return QIntegerTextBox
		 */
		public function txtName_Create($strControlId = null) {
			$this->txtName = new QIntegerTextBox($this->objParentObject, $strControlId);
		 ...
		 * @return QLabel
		 */
		public function lblName_Create($strControlId = null, $strFormat = null) {
			$this->lblName = new QLabel($this->objParentObject, $strControlId);
			$this->lblName->Name = QApplication::Translate('Name');
			$this->lblName->Text = $this->objPackage->Name;
			$this->lblName->Required = true;
			$this->lblName->Format = $strFormat;
			return $this->lblName;
		}
