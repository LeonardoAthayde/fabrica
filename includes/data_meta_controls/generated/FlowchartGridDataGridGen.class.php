<?php
	 ...
	 * listing a collection of FlowchartGrid objects.  It includes
	 ...
	 * 
	 */
	class FlowchartGridDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this FlowchartGrid datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the FlowchartGrid object, or it can be any QQNode extending from QQN::FlowchartGrid().
		 * 
		 ...
		 * sorting using two fields from the FlowchartGrid object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from FlowchartGrid
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = FlowchartGrid::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from FlowchartGrid, given the clauses above
			$this->DataSource = FlowchartGrid::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a FlowchartGrid-based QQNode.
		 * It will also verify that it is a proper FlowchartGrid-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'flowchart_grid') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "flowchart_grid".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::FlowchartGrid()->Id;
				case 'ColorId': return QQN::FlowchartGrid()->ColorId;
				case 'Color': return QQN::FlowchartGrid()->Color;
				case 'SizeId': return QQN::FlowchartGrid()->SizeId;
				case 'Size': return QQN::FlowchartGrid()->Size;
				case 'Amount': return QQN::FlowchartGrid()->Amount;
				case 'FlowchartOpId': return QQN::FlowchartGrid()->FlowchartOpId;
				case 'FlowchartOp': return QQN::FlowchartGrid()->FlowchartOp;
				default: throw new QCallerException('Simple Property not found in FlowchartGridDataGrid content: ' . $mixContent);
