<?php
	 ...
	 * listing a collection of OrdemProducaoGrade objects.  It includes
	 ...
	 * 
	 */
	class OrdemProducaoGradeDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this OrdemProducaoGrade datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the OrdemProducaoGrade object, or it can be any QQNode extending from QQN::OrdemProducaoGrade().
		 * 
		 ...
		 * sorting using two fields from the OrdemProducaoGrade object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from OrdemProducaoGrade
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = OrdemProducaoGrade::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from OrdemProducaoGrade, given the clauses above
			$this->DataSource = OrdemProducaoGrade::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a OrdemProducaoGrade-based QQNode.
		 * It will also verify that it is a proper OrdemProducaoGrade-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'ordem_producao_grade') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "ordem_producao_grade".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::OrdemProducaoGrade()->Id;
				case 'CorId': return QQN::OrdemProducaoGrade()->CorId;
				case 'Cor': return QQN::OrdemProducaoGrade()->Cor;
				case 'TamanhoId': return QQN::OrdemProducaoGrade()->TamanhoId;
				case 'Tamanho': return QQN::OrdemProducaoGrade()->Tamanho;
				case 'Quantidade': return QQN::OrdemProducaoGrade()->Quantidade;
				case 'Date': return QQN::OrdemProducaoGrade()->Date;
				case 'OrdemProducaoId': return QQN::OrdemProducaoGrade()->OrdemProducaoId;
				case 'OrdemProducao': return QQN::OrdemProducaoGrade()->OrdemProducao;
				case 'BalancoPecas': return QQN::OrdemProducaoGrade()->BalancoPecas;

				default: throw new QCallerException('Simple Property not found in OrdemProducaoGradeDataGrid content: ' . $mixContent);
