<?php
	 ...
	 * listing a collection of FluxogramaItemReal objects.  It includes
	 ...
	 * 
	 */
	class FluxogramaItemRealDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this FluxogramaItemReal datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the FluxogramaItemReal object, or it can be any QQNode extending from QQN::FluxogramaItemReal().
		 * 
		 ...
		 * sorting using two fields from the FluxogramaItemReal object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from FluxogramaItemReal
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = FluxogramaItemReal::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from FluxogramaItemReal, given the clauses above
			$this->DataSource = FluxogramaItemReal::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a FluxogramaItemReal-based QQNode.
		 * It will also verify that it is a proper FluxogramaItemReal-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'fluxograma_item_real') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "fluxograma_item_real".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::FluxogramaItemReal()->Id;
				case 'Referencia': return QQN::FluxogramaItemReal()->Referencia;
				case 'Acao': return QQN::FluxogramaItemReal()->Acao;
				case 'Maquina': return QQN::FluxogramaItemReal()->Maquina;
				case 'Tempo': return QQN::FluxogramaItemReal()->Tempo;
				case 'Profundidade': return QQN::FluxogramaItemReal()->Profundidade;
				case 'FluxogramaItemModeloId': return QQN::FluxogramaItemReal()->FluxogramaItemModeloId;
				case 'BalancoAcoes': return QQN::FluxogramaItemReal()->BalancoAcoes;

				default: throw new QCallerException('Simple Property not found in FluxogramaItemRealDataGrid content: ' . $mixContent);
