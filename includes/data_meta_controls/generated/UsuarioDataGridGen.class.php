<?php
	 ...
	 * 
	 */
	class UsuarioDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Usuario datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Usuario object, or it can be any QQNode extending from QQN::Usuario().
		 * 
		 ...
		 * sorting using two fields from the Usuario object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Usuario
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Usuario::QueryCount($objCondition, $objClauses);
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::Usuario()->Id;
				case 'Nome': return QQN::Usuario()->Nome;
				case 'Senha': return QQN::Usuario()->Senha;
				case 'CostureiraId': return QQN::Usuario()->CostureiraId;
				case 'Costureira': return QQN::Usuario()->Costureira;
