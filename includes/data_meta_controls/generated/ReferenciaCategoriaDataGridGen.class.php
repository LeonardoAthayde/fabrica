<?php
	 ...
	 * listing a collection of ReferenciaCategoria objects.  It includes
	 ...
	 * 
	 */
	class ReferenciaCategoriaDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ReferenciaCategoria datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ReferenciaCategoria object, or it can be any QQNode extending from QQN::ReferenciaCategoria().
		 * 
		 ...
		 * sorting using two fields from the ReferenciaCategoria object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ReferenciaCategoria
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ReferenciaCategoria::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from ReferenciaCategoria, given the clauses above
			$this->DataSource = ReferenciaCategoria::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ReferenciaCategoria-based QQNode.
		 * It will also verify that it is a proper ReferenciaCategoria-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'referencia_categoria') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "referencia_categoria".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::ReferenciaCategoria()->Id;
				case 'Nome': return QQN::ReferenciaCategoria()->Nome;
				default: throw new QCallerException('Simple Property not found in ReferenciaCategoriaDataGrid content: ' . $mixContent);
