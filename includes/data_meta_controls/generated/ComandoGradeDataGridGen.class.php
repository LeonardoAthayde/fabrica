<?php
	 ...
	 * listing a collection of ComandoGrade objects.  It includes
	 ...
	 * 
	 */
	class ComandoGradeDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ComandoGrade datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ComandoGrade object, or it can be any QQNode extending from QQN::ComandoGrade().
		 * 
		 ...
		 * sorting using two fields from the ComandoGrade object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ComandoGrade
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ComandoGrade::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from ComandoGrade, given the clauses above
			$this->DataSource = ComandoGrade::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ComandoGrade-based QQNode.
		 * It will also verify that it is a proper ComandoGrade-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'comando_grade') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "comando_grade".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::ComandoGrade()->Id;
				case 'ReferenciaId': return QQN::ComandoGrade()->ReferenciaId;
				case 'Referencia': return QQN::ComandoGrade()->Referencia;
				case 'TamanhoId': return QQN::ComandoGrade()->TamanhoId;
				case 'Tamanho': return QQN::ComandoGrade()->Tamanho;
				case 'ComandoTecidoPecaId': return QQN::ComandoGrade()->ComandoTecidoPecaId;
				case 'ComandoTecidoPeca': return QQN::ComandoGrade()->ComandoTecidoPeca;
				case 'QuantidadeRisco': return QQN::ComandoGrade()->QuantidadeRisco;
				case 'MeiaRisco': return QQN::ComandoGrade()->MeiaRisco;
				case 'QuantidadeReal': return QQN::ComandoGrade()->QuantidadeReal;
				case 'Peso': return QQN::ComandoGrade()->Peso;
				case 'BalancoPecasAsOrdemProducaoGrade': return QQN::ComandoGrade()->BalancoPecasAsOrdemProducaoGrade;

				default: throw new QCallerException('Simple Property not found in ComandoGradeDataGrid content: ' . $mixContent);
