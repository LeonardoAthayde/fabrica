<?php
	 ...
	 * listing a collection of Reference objects.  It includes
	 ...
	 * 
	 */
	class ReferenceDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Reference datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Reference object, or it can be any QQNode extending from QQN::Reference().
		 * 
		 ...
		 * sorting using two fields from the Reference object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Reference
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Reference::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Reference, given the clauses above
			$this->DataSource = Reference::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Reference-based QQNode.
		 * It will also verify that it is a proper Reference-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'reference') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "reference".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Reference()->Id;
				case 'Name': return QQN::Reference()->Name;
				case 'ReferenceCategoryId': return QQN::Reference()->ReferenceCategoryId;
				case 'ReferenceCategory': return QQN::Reference()->ReferenceCategory;
				case 'Model': return QQN::Reference()->Model;
				case 'TissueId': return QQN::Reference()->TissueId;
				case 'Tissue': return QQN::Reference()->Tissue;
				default: throw new QCallerException('Simple Property not found in ReferenceDataGrid content: ' . $mixContent);
