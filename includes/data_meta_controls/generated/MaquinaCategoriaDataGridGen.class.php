<?php
	 ...
	 * listing a collection of MaquinaCategoria objects.  It includes
	 ...
	 * 
	 */
	class MaquinaCategoriaDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this MaquinaCategoria datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the MaquinaCategoria object, or it can be any QQNode extending from QQN::MaquinaCategoria().
		 * 
		 ...
		 * sorting using two fields from the MaquinaCategoria object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from MaquinaCategoria
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = MaquinaCategoria::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from MaquinaCategoria, given the clauses above
			$this->DataSource = MaquinaCategoria::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a MaquinaCategoria-based QQNode.
		 * It will also verify that it is a proper MaquinaCategoria-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'maquina_categoria') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "maquina_categoria".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::MaquinaCategoria()->Id;
				case 'Nome': return QQN::MaquinaCategoria()->Nome;
				default: throw new QCallerException('Simple Property not found in MaquinaCategoriaDataGrid content: ' . $mixContent);
