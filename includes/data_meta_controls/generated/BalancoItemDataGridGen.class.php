<?php
	 ...
	 * listing a collection of BalancoItem objects.  It includes
	 ...
	 * 
	 */
	class BalancoItemDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this BalancoItem datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the BalancoItem object, or it can be any QQNode extending from QQN::BalancoItem().
		 * 
		 ...
		 * sorting using two fields from the BalancoItem object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from BalancoItem
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = BalancoItem::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from BalancoItem, given the clauses above
			$this->DataSource = BalancoItem::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a BalancoItem-based QQNode.
		 * It will also verify that it is a proper BalancoItem-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'balanco_item') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "balanco_item".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::BalancoItem()->Id;
				case 'Quantidade': return QQN::BalancoItem()->Quantidade;
				case 'Balanco': return QQN::BalancoItem()->Balanco;
				case 'OrdemProducaoGradeId': return QQN::BalancoItem()->OrdemProducaoGradeId;
				case 'OrdemProducaoGrade': return QQN::BalancoItem()->OrdemProducaoGrade;
				case 'FluxogramaItemId': return QQN::BalancoItem()->FluxogramaItemId;
				case 'FluxogramaItem': return QQN::BalancoItem()->FluxogramaItem;
				default: throw new QCallerException('Simple Property not found in BalancoItemDataGrid content: ' . $mixContent);
