<?php
	 ...
	 * listing a collection of FlowchartOp objects.  It includes
	 ...
	 * 
	 */
	class FlowchartOpDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this FlowchartOp datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the FlowchartOp object, or it can be any QQNode extending from QQN::FlowchartOp().
		 * 
		 ...
		 * sorting using two fields from the FlowchartOp object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from FlowchartOp
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = FlowchartOp::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from FlowchartOp, given the clauses above
			$this->DataSource = FlowchartOp::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a FlowchartOp-based QQNode.
		 * It will also verify that it is a proper FlowchartOp-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'flowchart_op') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "flowchart_op".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::FlowchartOp()->Id;
				case 'ProductionOrder': return QQN::FlowchartOp()->ProductionOrder;
				case 'PackageId': return QQN::FlowchartOp()->PackageId;
				case 'Package': return QQN::FlowchartOp()->Package;
				case 'Date': return QQN::FlowchartOp()->Date;
				default: throw new QCallerException('Simple Property not found in FlowchartOpDataGrid content: ' . $mixContent);
