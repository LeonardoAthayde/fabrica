<?php
	 ...
	 * listing a collection of CostureiraProducao objects.  It includes
	 ...
	 * 
	 */
	class CostureiraProducaoDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this CostureiraProducao datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the CostureiraProducao object, or it can be any QQNode extending from QQN::CostureiraProducao().
		 * 
		 ...
		 * sorting using two fields from the CostureiraProducao object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from CostureiraProducao
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = CostureiraProducao::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from CostureiraProducao, given the clauses above
			$this->DataSource = CostureiraProducao::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a CostureiraProducao-based QQNode.
		 * It will also verify that it is a proper CostureiraProducao-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'costureira_producao') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "costureira_producao".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::CostureiraProducao()->Id;
				case 'CostureiraId': return QQN::CostureiraProducao()->CostureiraId;
				case 'Costureira': return QQN::CostureiraProducao()->Costureira;
				case 'BalancoAcoesId': return QQN::CostureiraProducao()->BalancoAcoesId;
				case 'BalancoAcoes': return QQN::CostureiraProducao()->BalancoAcoes;
				case 'QuantidadePlanejada': return QQN::CostureiraProducao()->QuantidadePlanejada;
				case 'QuantidadeRealizada': return QQN::CostureiraProducao()->QuantidadeRealizada;
				case 'QuantidadeEstocado': return QQN::CostureiraProducao()->QuantidadeEstocado;
				case 'TempoPrevisto': return QQN::CostureiraProducao()->TempoPrevisto;
				case 'Concluido': return QQN::CostureiraProducao()->Concluido;
				default: throw new QCallerException('Simple Property not found in CostureiraProducaoDataGrid content: ' . $mixContent);
