<?php
	 ...
	 * listing a collection of Flowchart objects.  It includes
	 ...
	 * 
	 */
	class FlowchartDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Flowchart datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Flowchart object, or it can be any QQNode extending from QQN::Flowchart().
		 * 
		 ...
		 * sorting using two fields from the Flowchart object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Flowchart
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Flowchart::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Flowchart, given the clauses above
			$this->DataSource = Flowchart::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Flowchart-based QQNode.
		 * It will also verify that it is a proper Flowchart-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'flowchart') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "flowchart".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Flowchart()->Id;
				case 'ReferenceId': return QQN::Flowchart()->ReferenceId;
				case 'Reference': return QQN::Flowchart()->Reference;
				case 'Order': return QQN::Flowchart()->Order;
				case 'ActionsId': return QQN::Flowchart()->ActionsId;
				case 'Actions': return QQN::Flowchart()->Actions;
				case 'MachineId': return QQN::Flowchart()->MachineId;
				case 'Machine': return QQN::Flowchart()->Machine;
				case 'Time': return QQN::Flowchart()->Time;
				default: throw new QCallerException('Simple Property not found in FlowchartDataGrid content: ' . $mixContent);
