<?php
	 ...
	 * listing a collection of Tamanho objects.  It includes
	 ...
	 * 
	 */
	class TamanhoDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Tamanho datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Tamanho object, or it can be any QQNode extending from QQN::Tamanho().
		 * 
		 ...
		 * sorting using two fields from the Tamanho object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Tamanho
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Tamanho::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Tamanho, given the clauses above
			$this->DataSource = Tamanho::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Tamanho-based QQNode.
		 * It will also verify that it is a proper Tamanho-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'tamanho') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "tamanho".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Tamanho()->Id;
				case 'Valor': return QQN::Tamanho()->Valor;
				default: throw new QCallerException('Simple Property not found in TamanhoDataGrid content: ' . $mixContent);
