<?php
	 ...
	 * listing a collection of OrdemProducao objects.  It includes
	 ...
	 * 
	 */
	class OrdemProducaoDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this OrdemProducao datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the OrdemProducao object, or it can be any QQNode extending from QQN::OrdemProducao().
		 * 
		 ...
		 * sorting using two fields from the OrdemProducao object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from OrdemProducao
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = OrdemProducao::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from OrdemProducao, given the clauses above
			$this->DataSource = OrdemProducao::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a OrdemProducao-based QQNode.
		 * It will also verify that it is a proper OrdemProducao-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'ordem_producao') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "ordem_producao".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::OrdemProducao()->Id;
				case 'Numero': return QQN::OrdemProducao()->Numero;
				case 'ReferenciaId': return QQN::OrdemProducao()->ReferenciaId;
				case 'Referencia': return QQN::OrdemProducao()->Referencia;
				default: throw new QCallerException('Simple Property not found in OrdemProducaoDataGrid content: ' . $mixContent);
