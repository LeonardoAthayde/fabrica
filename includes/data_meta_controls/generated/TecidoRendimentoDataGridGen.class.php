<?php
	 ...
	 * listing a collection of TecidoRendimento objects.  It includes
	 ...
	 * 
	 */
	class TecidoRendimentoDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this TecidoRendimento datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the TecidoRendimento object, or it can be any QQNode extending from QQN::TecidoRendimento().
		 * 
		 ...
		 * sorting using two fields from the TecidoRendimento object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from TecidoRendimento
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = TecidoRendimento::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from TecidoRendimento, given the clauses above
			$this->DataSource = TecidoRendimento::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a TecidoRendimento-based QQNode.
		 * It will also verify that it is a proper TecidoRendimento-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'tecido_rendimento') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "tecido_rendimento".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::TecidoRendimento()->Id;
				case 'TecidoId': return QQN::TecidoRendimento()->TecidoId;
				case 'Comprimento': return QQN::TecidoRendimento()->Comprimento;
				case 'Largura': return QQN::TecidoRendimento()->Largura;
				case 'Peso': return QQN::TecidoRendimento()->Peso;
				default: throw new QCallerException('Simple Property not found in TecidoRendimentoDataGrid content: ' . $mixContent);
