<?php
	 ...
	 * listing a collection of ComandoItem objects.  It includes
	 ...
	 * 
	 */
	class ComandoItemDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ComandoItem datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ComandoItem object, or it can be any QQNode extending from QQN::ComandoItem().
		 * 
		 ...
		 * sorting using two fields from the ComandoItem object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ComandoItem
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ComandoItem::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from ComandoItem, given the clauses above
			$this->DataSource = ComandoItem::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ComandoItem-based QQNode.
		 * It will also verify that it is a proper ComandoItem-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'comando_item') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "comando_item".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::ComandoItem()->Id;
				case 'ComandoId': return QQN::ComandoItem()->ComandoId;
				case 'Comando': return QQN::ComandoItem()->Comando;
				case 'Referencia': return QQN::ComandoItem()->Referencia;
				default: throw new QCallerException('Simple Property not found in ComandoItemDataGrid content: ' . $mixContent);
