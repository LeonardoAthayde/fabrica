	...
	class MenuDataGridGen extends QDataGrid {
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Nome': return QQN::Menu()->Nome;
				case 'Link': return QQN::Menu()->Link;
				case 'MenuId': return QQN::Menu()->MenuId;
				case 'Menu': return QQN::Menu()->Menu;
				case 'Ordenacao': return QQN::Menu()->Ordenacao;
				case 'Icon': return QQN::Menu()->Icon;
