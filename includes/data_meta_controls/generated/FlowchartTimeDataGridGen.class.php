<?php
	 ...
	 * listing a collection of FlowchartTime objects.  It includes
	 ...
	 * 
	 */
	class FlowchartTimeDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this FlowchartTime datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the FlowchartTime object, or it can be any QQNode extending from QQN::FlowchartTime().
		 * 
		 ...
		 * sorting using two fields from the FlowchartTime object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from FlowchartTime
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = FlowchartTime::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from FlowchartTime, given the clauses above
			$this->DataSource = FlowchartTime::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a FlowchartTime-based QQNode.
		 * It will also verify that it is a proper FlowchartTime-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'flowchart_time') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "flowchart_time".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::FlowchartTime()->Id;
				case 'Name': return QQN::FlowchartTime()->Name;
				case 'Time': return QQN::FlowchartTime()->Time;
				case 'ColorId': return QQN::FlowchartTime()->ColorId;
				case 'Color': return QQN::FlowchartTime()->Color;
				case 'Amount': return QQN::FlowchartTime()->Amount;
				case 'Date': return QQN::FlowchartTime()->Date;
				case 'FlowchartId': return QQN::FlowchartTime()->FlowchartId;
				case 'FlowchartOpId': return QQN::FlowchartTime()->FlowchartOpId;
				case 'FlowchartOp': return QQN::FlowchartTime()->FlowchartOp;
				default: throw new QCallerException('Simple Property not found in FlowchartTimeDataGrid content: ' . $mixContent);
