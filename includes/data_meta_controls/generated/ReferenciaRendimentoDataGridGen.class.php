<?php
	 ...
	 * listing a collection of ReferenciaRendimento objects.  It includes
	 ...
	 * 
	 */
	class ReferenciaRendimentoDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ReferenciaRendimento datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ReferenciaRendimento object, or it can be any QQNode extending from QQN::ReferenciaRendimento().
		 * 
		 ...
		 * sorting using two fields from the ReferenciaRendimento object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ReferenciaRendimento
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ReferenciaRendimento::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from ReferenciaRendimento, given the clauses above
			$this->DataSource = ReferenciaRendimento::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ReferenciaRendimento-based QQNode.
		 * It will also verify that it is a proper ReferenciaRendimento-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'referencia_rendimento') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "referencia_rendimento".');
				...
				case 'Preco': return QQN::ReferenciaRendimento()->Preco;
				case 'TecidoId': return QQN::ReferenciaRendimento()->TecidoId;
				case 'Tecido': return QQN::ReferenciaRendimento()->Tecido;
				default: throw new QCallerException('Simple Property not found in ReferenciaRendimentoDataGrid content: ' . $mixContent);
