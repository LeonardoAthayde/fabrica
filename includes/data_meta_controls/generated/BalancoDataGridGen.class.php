<?php
	 ...
	 * listing a collection of Balanco objects.  It includes
	 ...
	 * 
	 */
	class BalancoDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Balanco datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Balanco object, or it can be any QQNode extending from QQN::Balanco().
		 * 
		 ...
		 * sorting using two fields from the Balanco object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Balanco
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Balanco::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Balanco, given the clauses above
			$this->DataSource = Balanco::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Balanco-based QQNode.
		 * It will also verify that it is a proper Balanco-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'balanco') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "balanco".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Balanco()->Id;
				case 'Quantidade': return QQN::Balanco()->Quantidade;
				case 'Balanco': return QQN::Balanco()->Balanco;
				case 'OrdemProducaoGradeId': return QQN::Balanco()->OrdemProducaoGradeId;
				case 'OrdemProducaoGrade': return QQN::Balanco()->OrdemProducaoGrade;
				case 'FluxogramaItemId': return QQN::Balanco()->FluxogramaItemId;
				case 'FluxogramaItem': return QQN::Balanco()->FluxogramaItem;
				default: throw new QCallerException('Simple Property not found in BalancoDataGrid content: ' . $mixContent);
