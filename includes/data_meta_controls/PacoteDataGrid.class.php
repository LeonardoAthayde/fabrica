<?php
	require(__DATAGEN_META_CONTROLS__ . '/PacoteDataGridGen.class.php');

	/**
	 * This is the "Meta" DataGrid customizable subclass for the List functionality
	 * of the Pacote class.  This code-generated class extends
	 * from the generated Meta DataGrid class which contains a QDataGrid class which
	 * can be used by any QForm or QPanel, listing a collection of Pacote
	 ...
	 * 
	 */
	class PacoteDataGrid extends PacoteDataGridGen {
	}
?>