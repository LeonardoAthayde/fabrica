...
//		protected function Form_Validate() {}
		...
		protected function Form_Create() {
			...
			$this->dtgMenus->CssClass = 'table table-bordered table-striped table-hover table-condensed';
			...
			$this->dtgMenus->MetaAddColumn('Nome');
			$this->dtgMenus->MetaAddColumn('Link');
			$this->dtgMenus->MetaAddColumn(QQN::Menu()->Menu);
			$this->dtgMenus->MetaAddColumn('Ordenacao');
			$this->dtgMenus->MetaAddColumn('Icon');
		}
	}
