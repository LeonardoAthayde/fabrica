<?php
	 ...
	 * CostureiraTempoEficienteDataGrid control which has meta-methods to help with
	 * easily creating/defining CostureiraTempoEficiente columns.
	 *
	 * Any display customizations and presentation-tier logic can be implemented
	 * here by overriding existing or implementing new methods, properties and variables.
	 * 
	 * NOTE: This file is overwritten on any code regenerations.  If you want to make
	 * permanent changes, it is STRONGLY RECOMMENDED to move both costureira_tempo_eficiente_list.php AND
	 * costureira_tempo_eficiente_list.tpl.php out of this Form Drafts directory.
	 *
	 * @package My Application
	 * @subpackage Drafts
	 */
	class CostureiraTempoEficienteListForm extends QForm {
	
		protected $objUsuario;
	
		// Local instance of the Meta DataGrid to list CostureiraTempoEficientes
		protected $dtgCostureiraTempoEficientes;
...
//		protected function Form_Validate() {}
		...
		protected function Form_Create() {
			...
			$this->dtgCostureiraTempoEficientes->CssClass = 'table table-bordered table-striped table-hover table-condensed';
			...
			$strEditPageUrl = __VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/costureira_tempo_eficiente_edit.php';
			$this->dtgCostureiraTempoEficientes->MetaAddEditLinkColumn($strEditPageUrl, 'Edit', 'Edit');
	...
	// costureira_tempo_eficiente_list.tpl.php as the included HTML template file
	CostureiraTempoEficienteListForm::Run('CostureiraTempoEficienteListForm');
?>