...
?>
	...
	<div id="formControls">
		...
		<?php $this->lstParentFluxogramaItemsAsFluxogramaDepedencia->RenderWithName(true, "Rows=7"); ?>

		<?php $this->lstFluxogramaItemsAsFluxogramaDepedencia->RenderWithName(true, "Rows=7"); ?>
