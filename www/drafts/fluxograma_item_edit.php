<?php
	 ...
	 * @subpackage Drafts
	 */
	class FluxogramaItemEditForm extends QForm {
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the FluxogramaItemMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctFluxogramaItem = FluxogramaItemMetaControl::CreateFromPathInfo($this);
			...
			$this->txtOrdenacao = $this->mctFluxogramaItem->txtOrdenacao_Create();
			...
			$this->chkAtivo = $this->mctFluxogramaItem->chkAtivo_Create();
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/fluxograma_item_list.php');
		}
	}

	// Go ahead and run this form object to render the page and its event handlers, implicitly using
	// fluxograma_item_edit.tpl.php as the included HTML template file
	FluxogramaItemEditForm::Run('FluxogramaItemEditForm');
?>