<?php
	 ...
	 * @subpackage Drafts
	 */
	class TecidoRendimentoEditForm extends QForm {
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the TecidoRendimentoMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctTecidoRendimento = TecidoRendimentoMetaControl::CreateFromPathInfo($this);
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/tecido_rendimento_list.php');
		}
	}

	// Go ahead and run this form object to render the page and its event handlers, implicitly using
	// tecido_rendimento_edit.tpl.php as the included HTML template file
	TecidoRendimentoEditForm::Run('TecidoRendimentoEditForm');
?>