...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			$this->txtBarcode = $this->mctCostureira->txtBarcode_Create();
			$this->txtBarcodeImagemFla = $this->mctCostureira->txtBarcodeImagemFla_Create();
