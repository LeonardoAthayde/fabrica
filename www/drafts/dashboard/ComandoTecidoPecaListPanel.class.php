<?php
	 ...
	 * list a collection of ComandoTecidoPeca objects.  It includes
	 * functionality to perform pagination and sorting on columns.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QPanel which extends this ComandoTecidoPecaListPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	class ComandoTecidoPecaListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list ComandoTecidoPecas
		public $dtgComandoTecidoPecas;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = 'ComandoTecidoPecaListPanel.tpl.php';

			// Instantiate the Meta DataGrid
			$this->dtgComandoTecidoPecas = new ComandoTecidoPecaDataGrid($this);

			// Style the DataGrid (if desired)
			$this->dtgComandoTecidoPecas->CssClass = 'datagrid';
			...
			$this->dtgComandoTecidoPecas->ItemsPerPage = 8;
			...
			$this->dtgComandoTecidoPecas->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
			...
			$this->btnCreateNew->Text = QApplication::Translate('Create a New') . ' ' . QApplication::Translate('ComandoTecidoPeca');
			$this->btnCreateNew->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnCreateNew_Click'));
		}

		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			$strParameterArray = explode(',', $strParameter);
			$objEditPanel = new ComandoTecidoPecaEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
		...
		public function btnCreateNew_Click($strFormId, $strControlId, $strParameter) {
			$objEditPanel = new ComandoTecidoPecaEditPanel($this, $this->strCloseEditPanelMethod, null);
			$strMethodName = $this->strSetEditPanelMethod;
			$this->objForm->$strMethodName($objEditPanel);
		}
	}
