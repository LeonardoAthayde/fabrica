<?php
	 ...
	 * list a collection of BalancoPecas objects.  It includes
	 * functionality to perform pagination and sorting on columns.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QPanel which extends this BalancoPecasListPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	class BalancoPecasListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list BalancoPecases
		public $dtgBalancoPecases;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = 'BalancoPecasListPanel.tpl.php';
			...
			$this->dtgBalancoPecases->ItemsPerPage = 8;
			...
			$this->dtgBalancoPecases->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
			...
			$this->dtgBalancoPecases->MetaAddColumn('Concluido');

			// Setup the Create New button
			$this->btnCreateNew = new QButton($this);
			$this->btnCreateNew->Text = QApplication::Translate('Create a New') . ' ' . QApplication::Translate('BalancoPecas');
			$this->btnCreateNew->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnCreateNew_Click'));
		}

		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			$strParameterArray = explode(',', $strParameter);
			$objEditPanel = new BalancoPecasEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
		...
		public function btnCreateNew_Click($strFormId, $strControlId, $strParameter) {
			$objEditPanel = new BalancoPecasEditPanel($this, $this->strCloseEditPanelMethod, null);
			$strMethodName = $this->strSetEditPanelMethod;
			$this->objForm->$strMethodName($objEditPanel);
		}
	}
