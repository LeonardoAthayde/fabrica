<?php
	 ...
	 * list a collection of ReferenciaRendimento objects.  It includes
	 * functionality to perform pagination and sorting on columns.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QPanel which extends this ReferenciaRendimentoListPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	class ReferenciaRendimentoListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list ReferenciaRendimentos
		public $dtgReferenciaRendimentos;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = 'ReferenciaRendimentoListPanel.tpl.php';

			// Instantiate the Meta DataGrid
			$this->dtgReferenciaRendimentos = new ReferenciaRendimentoDataGrid($this);

			// Style the DataGrid (if desired)
			$this->dtgReferenciaRendimentos->CssClass = 'datagrid';
			...
			$this->dtgReferenciaRendimentos->ItemsPerPage = 8;
			...
			$this->dtgReferenciaRendimentos->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
			...
			$this->btnCreateNew->Text = QApplication::Translate('Create a New') . ' ' . QApplication::Translate('ReferenciaRendimento');
			$this->btnCreateNew->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnCreateNew_Click'));
		}

		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			$strParameterArray = explode(',', $strParameter);
			$objEditPanel = new ReferenciaRendimentoEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
		...
		public function btnCreateNew_Click($strFormId, $strControlId, $strParameter) {
			$objEditPanel = new ReferenciaRendimentoEditPanel($this, $this->strCloseEditPanelMethod, null);
			$strMethodName = $this->strSetEditPanelMethod;
			$this->objForm->$strMethodName($objEditPanel);
		}
	}
