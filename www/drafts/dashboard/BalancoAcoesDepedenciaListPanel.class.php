<?php
	 ...
	 * list a collection of BalancoAcoesDepedencia objects.  It includes
	 * functionality to perform pagination and sorting on columns.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QPanel which extends this BalancoAcoesDepedenciaListPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	class BalancoAcoesDepedenciaListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list BalancoAcoesDepedencias
		public $dtgBalancoAcoesDepedencias;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = 'BalancoAcoesDepedenciaListPanel.tpl.php';

			// Instantiate the Meta DataGrid
			$this->dtgBalancoAcoesDepedencias = new BalancoAcoesDepedenciaDataGrid($this);

			// Style the DataGrid (if desired)
			$this->dtgBalancoAcoesDepedencias->CssClass = 'datagrid';
			...
			$this->dtgBalancoAcoesDepedencias->ItemsPerPage = 8;
			...
			$this->dtgBalancoAcoesDepedencias->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
			...
			$this->btnCreateNew->Text = QApplication::Translate('Create a New') . ' ' . QApplication::Translate('BalancoAcoesDepedencia');
			$this->btnCreateNew->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnCreateNew_Click'));
		}

		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			$strParameterArray = explode(',', $strParameter);
			$objEditPanel = new BalancoAcoesDepedenciaEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
		...
		public function btnCreateNew_Click($strFormId, $strControlId, $strParameter) {
			$objEditPanel = new BalancoAcoesDepedenciaEditPanel($this, $this->strCloseEditPanelMethod, null);
			$strMethodName = $this->strSetEditPanelMethod;
			$this->objForm->$strMethodName($objEditPanel);
		}
	}
