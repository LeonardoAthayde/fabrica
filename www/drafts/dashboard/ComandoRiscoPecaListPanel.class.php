<?php
	 ...
	 * list a collection of ComandoRiscoPeca objects.  It includes
	 * functionality to perform pagination and sorting on columns.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QPanel which extends this ComandoRiscoPecaListPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	class ComandoRiscoPecaListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list ComandoRiscoPecas
		public $dtgComandoRiscoPecas;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = 'ComandoRiscoPecaListPanel.tpl.php';

			// Instantiate the Meta DataGrid
			$this->dtgComandoRiscoPecas = new ComandoRiscoPecaDataGrid($this);

			// Style the DataGrid (if desired)
			$this->dtgComandoRiscoPecas->CssClass = 'datagrid';
			...
			$this->dtgComandoRiscoPecas->ItemsPerPage = 8;
			...
			$this->dtgComandoRiscoPecas->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
			...
			$this->btnCreateNew->Text = QApplication::Translate('Create a New') . ' ' . QApplication::Translate('ComandoRiscoPeca');
			$this->btnCreateNew->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnCreateNew_Click'));
		}

		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			$strParameterArray = explode(',', $strParameter);
			$objEditPanel = new ComandoRiscoPecaEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
		...
		public function btnCreateNew_Click($strFormId, $strControlId, $strParameter) {
			$objEditPanel = new ComandoRiscoPecaEditPanel($this, $this->strCloseEditPanelMethod, null);
			$strMethodName = $this->strSetEditPanelMethod;
			$this->objForm->$strMethodName($objEditPanel);
		}
	}
